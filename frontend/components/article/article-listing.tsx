      ...
      if (pageNum <= totalPages) {
        buttons.push(
          <Button
            ...
            variant="outline"
            size="sm"
            className={`h-8 w-8 border-none ${pageNum === page ? "bg-primary text-white hover:bg-primary" : ""}`}
            onClick={() => {
  ...
  return (
    <div className="container py-8 relative">
      ...
      <div className="mb-8 space-y-4">
        ...
        {/* 활성화된 필터 표시 */}
        {(selectedCategories.length > 0 || priceRange[0] > 0 || priceRange[1] < maxPrice || searchQuery) && (
